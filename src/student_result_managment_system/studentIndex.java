...
public class studentIndex extends javax.swing.JFrame {
   ...
   public studentIndex() {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Electrical Machines");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            if(rs.next()){
                ...
                int s5 = Integer.parseInt(jTextField14.getText());
                int result = s1+s2+s3+s4+s5;
                String k = String.valueOf(result);
                jTextField11.setText(k);
                
                if(s1<30||s2<30||s3<30||s4<30||s5<30){
                    jTextField12.setText("Fail");
                    jLabel24.setText("Better luck next time");
                }
                else
                {
                    jTextField12.setText("Pass");
                    jLabel24.setText("Congratulations!");
                }
            }
        }
        catch(Exception e){
